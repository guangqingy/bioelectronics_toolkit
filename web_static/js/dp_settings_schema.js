...
const SETTINGS_SCHEMAS = {
  ...
  histology_naming: [
    {section: 'Project'}, {id: 'histologyProjectPath', label: 'Histology project local file', type: 'path'}, {id: 'histologyProjectAddPath', label: 'Image file/folder to add', type: 'path'}, {id: 'histologyProjectEntryName', label: 'Project display name', type: 'text'},
    {section: 'Case Folder'}, {id: 'projectPath', label: 'Histology case folder', type: 'path'}, {id: 'qupathProject', label: 'QuPath project file', type: 'path'},
    {section: 'Folder Naming'}, {id: 'rotateDeg', label: 'Rotation', type: 'select'}, {id: 'newName', label: 'New name', type: 'text'}, {id: 'suffixList', label: 'Suffix list', type: 'textarea'}, {id: 'suffixPick', label: 'Selected suffix', type: 'select'}, {id: 'useSuffix', label: 'Append suffix', type: 'checkbox'}, {id: 'updateQuPath', label: 'Update QuPath name', type: 'checkbox'},
  ],
  histology_analysis: [
