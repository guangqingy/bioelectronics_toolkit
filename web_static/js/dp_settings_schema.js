...
const SETTINGS_SCHEMAS = {
  ...
  histology_naming: [
    {section: 'Paths'}, {id: 'projectPath', label: 'Histology case folder', type: 'path'}, {id: 'qupathProject', label: 'QuPath project file', type: 'path'},
  ...
  histology_analysis: [
    {section: 'Paths'}, {id: 'qupathProject', label: 'QuPath project file', type: 'path'},
