const GUI_ITEMS = [
  ...
  {
    id: 'fluorescence_timecourse',
    name: 'Fluorescence Timecourse',
    desc: 'Draw polygon ROIs on TIFF time series and analyze fluorescence intensity over time.',
    why: 'Use this when you need per-ROI time traces from a fluorescence sequence without generating a GIF first.',
    tag: 'ROI Time',
    domain: 'Imaging',
    href: '/fluorescence/timecourse',
  },
  {
    id: 'fluorescence_kymograph',
    name: 'Fluorescence Kymograph',
    desc: 'Draw ROIs and build intensity-distribution kymographs from TIFF time series.',
    why: 'Use this when an ROI needs frame-by-frame spatial or intensity distribution review.',
    tag: 'Kymograph',
    domain: 'Imaging',
    href: '/fluorescence/kymograph',
  },
  {
  ...
  },
  {
    ...
    desc: 'Open a DataProcess histology project, draw polygon ROIs, tune DAPI/FITC/Cy5 thresholds, and save marker results to project sidecars.',
