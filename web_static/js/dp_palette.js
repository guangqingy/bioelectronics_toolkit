const DP_STATIC_COMMANDS = [
  ...
  {label: 'Histology naming', url: '/histology?module=naming', section: 'Tool', keywords: 'histology rename qupath naming project'},
  {label: 'Histology ROI analysis', url: '/histology?module=analysis', section: 'Tool', keywords: 'histology roi sma macrophage dapi fitc cy5 threshold analysis'},
