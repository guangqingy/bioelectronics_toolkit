const DP_STATIC_COMMANDS = [
  ...
  {label: 'Histology naming', url: '/histology/naming', section: 'Tool', keywords: 'histology dataprocess project rename ets qupath naming'},
  {label: 'Histology ROI analysis', url: '/histology/analysis', section: 'Tool', keywords: 'histology dataprocess project ets roi sma macrophage dapi fitc cy5 threshold analysis'},
