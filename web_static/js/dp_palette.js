const DP_STATIC_COMMANDS = [
  ...
  {label: 'Histology naming', url: '/histology/naming', section: 'Tool', keywords: 'histology rename qupath naming project'},
  {label: 'Histology ROI analysis', url: '/histology/analysis', section: 'Tool', keywords: 'histology ets roi sma macrophage dapi fitc cy5 threshold analysis'},
